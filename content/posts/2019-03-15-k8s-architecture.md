---
title: "K8s核心架构"
date: 2019-03-14T23:45:00+08:00
comments: true
keywords: K8s
description: K8s

categories: ["K8s"]
url: /blog/2019/03/14/k8s-architecture/
---
...
### K8s整体架构
<img src="/images/k8s/kubernetes-whole-arch.png" />


##### K8s-Master架构图
<img src="/images/k8s/kubernetes-master-arch.png" />

##### K8s-Node架构图
<img src="/images/k8s/kubernetes-node-arch.png" />

### K8s分层架构
<img src="/images/k8s/kubernetes-layers-arch.png" />

### K8s简化图
<img src="/images/k8s/k8s-control-plane.jpg" />
