---
title: "K8s之Service"
date: 2019-03-17T20:45:00+08:00
comments: true
keywords: K8s
description: K8s

categories: ["K8s"]
url: /blog/2019/03/17/k8s-concept-service/
---
...
<img src="/images/k8s/k8s-service-1.png" />

 通过 Label Selector，一组 Pod 能够被暴露为Service，供客户端访问。

 <img src="/images/k8s/k8s-service-2.png" />
...
<img src="/images/k8s/k8s-service-3.png" />
...
<img src="/images/k8s/k8s-service-4.png" />
...
如下图所示：
<img src="/images/k8s/k8s-service-5.png" />
...
<img src="/images/k8s/k8s-service-7.png" />
    ...
    http:
      ...
      - path: /foo                  
        backend:                    
          ...
          servicePort: 80           
```
<img src="/images/k8s/k8s-service-6.png" />
